export const IS_MAINNET                 = Boolean(process.env.REACT_APP_IS_MAINNET !== 'true');  // If REACT_APP_IS_MAINNET is unset, set it to true by default
export const IS_NON_INFURA_TESTNET      = !IS_MAINNET && process.env.REACT_APP_RPC_URL
export const TESTNET_ITERATION          = process.env.REACT_APP_TESTNET_ITERATION || null;
export const TESTNET_LAUNCHPAD_NAME     = `${process.env.REACT_APP_TESTNET_LAUNCHPAD_NAME}` || 'DaVinci Mainnet';
...
export const TICKER_NAME                = IS_MAINNET ? 'DCOIN' : 'DaVinci';
export const ETHERSCAN_URL              = IS_MAINNET ? 'https://mainnet-explorer.davinci.bz/tx' : `https://testnet-explorer.davinci.bz/tx`;
export const BEACONSCAN_URL             = IS_MAINNET ? 'https://validator-explorer.davinci.bz/validators' : `https://validator-testnet.davinci.bz/validators`;
export const BEACONCHAIN_URL            = (IS_NON_INFURA_TESTNET && process.env.REACT_APP_BEACONCHAIN_URL) ||  `https://validator-testnet.davinci.bz/validators`;
export const FORTMATIC_KEY              = process.env.REACT_APP_FORTMATIC_KEY       || 'pk_test_D113D979E0D3508F';
export const CONTRACT_ADDRESS           = IS_MAINNET ? '0xdeadbeef00000000000000000000000000000000' : process.env.REACT_APP_CONTRACT_ADDRESS;
...
let forkVersion = Buffer.from('10000293', 'hex')
